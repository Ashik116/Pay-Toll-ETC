...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return !isLoading? const loadingAnimation() :Scaffold(
                  ...
                  child: Column(
                    children:  <Widget>[
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                            icon: IconButton(
                              icon: const Icon(Icons.vpn_key,color: Color(0xFF176EB0),),
                              onPressed: (){
                                setState(() {
                ...
                Align(
                    ...
                    child: Container(
                        ...
                        child: GestureDetector(
                          onTap: (){Navigator.push(context, MaterialPageRoute(builder: (_)=>const Test()));},
                          child: const Text(
                            "FORGOT PASSWORD?",
                            style:
